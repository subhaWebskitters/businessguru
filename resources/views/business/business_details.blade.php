		...
		<div class="deatils_outer clear">
				<div class="summary">
						...
						<div class="border_box upload_img upload_border clear discoverDetailsBorder portfolioUpload">
							...
							/*--}}
							@if($extension == 'mp4' || $extension == 'avg' || $extension == 'mkv')
							  <li>
																<a  href="javascript:void(0);" title="{{$files->file_name}}">
																		{{ Html::image(asset('images/img18.jpg')) }}
																</a>
				...
				{!! Form::file('media[]',array( 'placeholder'=>'Logo','class'=>'form-control media')) !!}
				{!! Form::file('media[]',array( 'placeholder'=>'Logo','class'=>'form-control media')) !!}
				{!! Form::file('media[]',array( 'placeholder'=>'Logo','class'=>'form-control media')) !!}
				{!! Form::file('media[]',array( 'placeholder'=>'Logo','class'=>'form-control media')) !!}
				{!! Form::file('media[]',array( 'placeholder'=>'Logo','class'=>'form-control media')) !!}
...
<li><a href="{{URL::route('download_file',$filename)}}"><div class="portfolio_display">
				...
				{!! Form::file('upload_doc[]',array( 'placeholder'=>'Upload Doc','class'=>'form-control upload_doc  ')) !!}
				{!! Form::file('upload_doc[]',array( 'placeholder'=>'Upload Doc','class'=>'form-control upload_doc ')) !!}
				{!! Form::file('upload_doc[]',array( 'placeholder'=>'Upload Doc','class'=>'form-control upload_doc ')) !!}
...
<!--	    <div class="border_box">
		...
		<div class="one_tab_inner clear">
		  <div class="select_input clear">
		    <div class="cust_select_sec2">
		      {!! Form::select('currency', $currency, $businessDetails->currency,array('id'=>'currency','class' => 'form-control','style' => 'background-color:#009AE1')) !!}
		    </div>
		...
		<div class="one_tab_inner clear">
		  <div class="select_input clear">
		    <div class="cust_select_sec2">
		      {!! Form::select('sp_currency', $currency, $businessDetails->sp_currency,array('id'=>'sp_currency','class' => 'form-control','style' => 'background-color:#009AE1')) !!}
		    </div>
