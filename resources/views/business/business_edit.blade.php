...
<div class="container">
    <div class="row">.
		<p><a href="{{URL::route('business_changepassword')}}">Change Password</a></p>
		<p><a href="{{URL::route('business_editprofile',Session::get('BUSINESS_ID'))}}">Edit Profile</a></p>
		<p><a href="{{URL::route('business_logout')}}">Logout</a></p>
	...
	<div class="formRow">
	  <div class="">
	    <div class="form_sep">
		    ...
		    /*--}}
	    <div class="form_sep">
	      <label class="req">Am I a </label> {{$business->user_type}}
		  ...
		  <div class="form_sep">
		   ...
		   <div class="form_sep">
		    ...
		    {!! Form::select('business_cat[]', $industry, $selected_category,array('id'=>'business_cat','class' => 'form-control','multiple' => "multiple")) !!}
		   </div>
	       </div>
		...
		<div id="image-holder"></div>
		     @if($business->business_logo!= '' && file_exists(public_path().'/upload/businessuser/thumb/'.$business->business_logo) )
				{!! Html::image(asset('upload/businessuser/'.$business->business_logo),$business->business_logo,array('height'=>'400','width'=>'400'))!!}
			      @else
	    ...
	    <div class="form_sep">
	      ...
	      <div id="textarea_feedback"></div>
	       ...
	       <span class="masterTooltipNew">(?)
		    ...
		    <div class="doc_list">
		    <a href="{{ URL::route('download',array('doc',$filename)) }}">{{$filename}}</a>
	  ...
	  <div class="form-group"> 
	    ...
	    Upload Your ... 
	       <div class="form_sep">
		    ...
		    <a href="{{ URL::route('download',array('salse',$business->sales_report_name)) }}">Download</a>
		    <div>
			      <!--<a href="">{{$business->sales_report}}</a>-->
		    </div>
	       ...
	       <div class="form_sep">
		    ...
		    <a href="{{ URL::route('download',array('pll',$business->pll_report_name)) }}">Download</a>
	       ...
	       <div class="form_sep">
		    ...
		    <a href="{{ URL::route('download',array('valuation',$business->valuation_report_name)) }}">Download</a>
