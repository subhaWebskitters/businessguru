		...
		<div id="main" class="clear">
				<div class="errorSuccess">
						@if(Session::has('errorMessage'))
								<div class="nNote nFailure"><p>{{ Session::get('errorMessage') }}</p></div>
						@endif
						@if(Session::has('successMessage'))
								<div class="nNote nSuccess">{{ Session::get('successMessage') }}</div>
						@endif
								...
								<div id="horizontalTab">
										...
										<div class="resp-tabs-container">
												<div class="accordian_box business_signup">
														{!! Form::open(['route'=>'save_business_step','class' => 'form form-validate formRow clear ','id'=>'business_form','enctype'=>'multipart/form-data', 'files'=>true]) !!}
																...
																<div class="signup_basic"  style="display:block;"> 
																		...
																		<div class="three_option clear">
																				...
																				<div class="three_option_inner clear">
																						<div class="cust_radio">
																								{!! Form::radio('business_type', 'start_up', '', array('id'=>"radio-1-1" ,'class' => 'regular-radio basicType business_type','checked'=>'checked')) !!}
																								<label for="radio-1-1"></label>
																								<label for="radio-1-1" class="click_radio">Start Up</label>
																						</div>
																						<div class="cust_radio">
																								{!! Form::radio('business_type', 'existing_business', '', array('id'=>"radio-1-2" ,'class' => 'regular-radio basicType business_type')) !!}
																								<label for="radio-1-2"></label>
																								<label for="radio-1-2" class="click_radio">Existing Business </label>
																						</div>
																						<div class="cust_radio">
																								{!! Form::radio('business_type', 'business_ideas', '', array('id'=>"radio-1-3" ,'class' => 'regular-radio basicType business_type')) !!}
																		...
																		<div class="tab_content business_first_step clear" style="display:none;">
																				<div class="tab_content_left">
																						...
																						<div class="tab_form clear">
																								...
																								<div class="existing" style="display:none;">
																										<div class="tab_form_right one_tab">
																												...
																												<div class="one_tab_inner">
																														{!! Form::text('contact','',array('id'=>'contact','placeholder'=>' Contact No With country Code(+123456789)','class'=>'form-control')) !!}
																												</div>			  
																										</div>
																								</div>
																						</div>
																						...
																						<div class="tab_form clear">
																								<div class="general"  style="display:none;">
																										<div class="tab_form_left one_tab">
																												...
																												<div class="one_tab_inner">
																														{!! Form::text('acta_number','',array('id'=>'acra_number','placeholder'=>'ACRA Number','class'=>'form-control required')) !!}
																												</div>
																										</div>
																								</div>
																								<div class="existing" style="display:none;">
																										<div class="tab_form_right one_tab">
																												...
																												<div class="one_tab_inner">
																														{!! Form::email('buss_email', $email, array('id'=>'buss_email', 'placeholder'=>'Email', 'class'=>'form-control','readonly')) !!}
																												</div>			  
																										</div>
																								</div>
																						</div>
																						<div class="tab_form clear">
																								...
																								<div class="existing" style="display:none;">
																										<div class="tab_form_right one_tab">
																												<label>Website</label>
																												<div class="one_tab_inner">
																														{!! Form::url('website','http://',array('id'=>'website','placeholder'=>'http://www.website.com/', 'class'=>'form-control')) !!}
																												</div>			  
																										</div>
																								</div>
																						</div>
																						<div class="general" style="display:none;">
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														{!! Form::text('director_name[]','',array('id'=>'add_director_1','placeholder'=>'Director Name','class'=>'form-control required')) !!}
																														<a href="javascript:void(0)" class="add_director">Add More + </a>
																														<input type="hidden" name="director_count" class="director_count" value="1">
																												</div>
																										</div>
																								</div>
																						</div>
																						<div class="business" style="display:none;">
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab full-tab_new">
																												...
																												<div class="one_tab_inner tab_select">
																														<div class="select-business">
																															{!! Form::select('business_cat[]', $industry, '',array('multiple id'=>'business_cat','class' => 'form-control businessCatCheckbox','multiple' => "multiple")) !!}
																																...
																																<div id="checkboxes" class="clear">
																																	...
																																	@foreach($industry as $key => $val)
																																		<label for="one"><input type="checkbox" name="business_cat[]" value="{{$key}}" id="business_cat" class="businessCatCheckbox" />{{$val}}</label>
																																	@endforeach
...
-->																								</div>
  																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab full-tab_new">
																												<label class="dubble_line">Investor Type</label>
																												<div class="one_tab_inner tab_select">
																														<div>
															{!! Form::select('investor_type', array(''=>'Select Investor Type','Single Investors'=>'Single Investors','Multiple Investors'=>'Multiple Investors'),'',array('class' => '','id'=> 'investor_type','style' => 'background-color:white;height:41px')) !!}
											...
											<p>																			{!! Form::file('upload_doc[]',array('id'=>'add_file_1', 'placeholder'=>'Upload Doc','class'=>'form-control upload_doc ')) !!}
											</p>
											<p>																			{!! Form::file('upload_doc[]',array('id'=>'add_file_1', 'placeholder'=>'Upload Doc','class'=>'form-control upload_doc ')) !!}
											</p>
											<p>
											...
											<p>
																														...
																														<!--
																														<a href="javascript:void(0)" class="add_file">Add More</a>
																														<input type="hidden" name="file_count" class="file_count" value="1">
																														-->
																														<!--
																						...
																						<div class="submit_form">
																								{!! Form::button('Next',array('id'=>'next2')) !!}
																						</div>
																				</div>
																				<div class="general"  style="display:none;">
																						<div class="tab_content_right">
																								<img src="images/img11.jpg" alt="no img" id="buss_logo">
																								<div style="display:none;">
																								{!! Form::file('image',array('class'=>"form-control", 'placeholder'=>"Logo", 'id'=>"image")) !!}
																								</div>
																								<div id="buss_image-holder" style="color:red;"></div>
																						</div>
																				</div>
																		</div>
																</div>
																		...
																		<div class="three_option clear">
																				...
																				<div class="three_option_inner clear">
																						<div class="cust_radio">
																								...
																								{!! Form::radio('looking_for', 'investors', '', array('id'=>"radio-2-1",'class' => 'regular-radio proposalType looking_for', 'checked' => 'checked')) !!}
																								<label for="radio-2-1"></label>
																								<label for="radio-2-1" class="click_radio">Investors</label>
																						</div>
																						<div class="cust_radio">
																								{!! Form::radio('looking_for', 'selling_your_company', '', array('id'=>"radio-2-2",'class' => 'regular-radio proposalType looking_for')) !!}
																						...
																						<div class="tab2_inner">
																												...
																												<div class="one_tab_inner">
																														<div class="select_input clear">
																																<div class="cust_select_sec2">
																																		{!! Form::select('funds_req_currency', $currency, '',array('id'=>'funds_req_currency','class' => 'form-control' , 'style' => 'background-color:#009AE1')) !!}
																																</div>
																								...
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner upload_prop">
																														<img src="images/img13.jpg" alt="no img" id="proposalImage" style="cursor:pointer;">
																								...
																								<div class="use_full_tips clear">
																										...
																										<div class="tips_inner clear">
																												...
																												<div class="tips_right">
																														<p>Proposal format is preferred by Spring Singapore <a href="{{URL::route('download_file','1463563557.docx')}}" class="download_files" data-file="filename.txt">click here</a> to download a copy</p>
																												</div>
																										</div>
																								</div>
																						</div>
																		...
																		<div class="selling_your_company" style="display:none;">
																				<div class="tab_content clear">
																						<div class="tab2_inner">
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														<div class="select_input clear">
																																<div class="cust_select_sec2">
																																		{!! Form::select('sp_currency', $currency, '',array('id'=>'sp_currency','class' => 'form-control','style' => 'background-color:#009AE1')) !!}
																																</div>
																																{!! Form::number('enter_selling_amt','',array('id'=>'enter_sell_amt','placeholder'=>'Enter Amount','class'=>'form-control required')) !!}
																														</div>
																												</div>
																										</div>
																								</div>
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														<div class="select_input clear">
																																<div class="cust_select_sec2">
																																		{!! Form::select('cv_currency', $currency, '',array('id'=>'cv_currency','class' => 'form-control', 'style' => 'background-color:#009AE1')) !!}
																																</div>
																								...
																								-->
																								<p class="icon15">If you wish to get an accurate valuation, Contact us to get a valuation.
																										<a href="javascript:void(0);" class="mail_accurate_valuation" data-href="{{$site_settings->sitesettings_value}}"  data-item="{{$site_settings->sitesettings_lebel}}">click here</a>
																								</p>
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												<label class="dubble_line">Upload Your  <br>Proposal <span>(PDF, DOCX)</span></label>
																												<div class="one_tab_inner upload_prop">
																														<img src="images/img13.jpg" alt="no img" id="proposalImage1"  style="cursor:pointer;">
																														{!! Form::file('upload_proposal_selling',array('id'=>'upload_proposal1', 'placeholder'=>'Upload Proposal','class'=>'form-control upload_proposal1 ')) !!}
																										...
																										<div class="tips_inner clear">
																												<div class="tips_left">
																														<span class="masterTooltipNew">
																																<img src="images/img14.jpg" alt="no img">
																																<strong class="infoBox"><span>PDF of preferred proposal format</span> </strong>
																														</span>
																												</div>
																												<div class="tips_right">
																														<p>Proposal format is preferred by Spring Singapore
																																<a href="{{URL::route('download_file','1463563557.docx')}}" class="download_files" data-file="filename.txt">click here</a> to download a copy
																														</p>
																												</div>
																										</div>
																								</div>
		...
		<div class="three_option clear">
		  <h2>we need your books...</h2>
		</div>															
																		<div class="three_option_inner clear">
																				<div class="cust_radio">
																						<input type="radio" id="radio-3-1" name="radio-1-set" disabled class="regular-radio accountType" value="1">
																						<label for="radio-3-1"></label>
																						<label class="click_radio" for="radio-3-1">Start Up</label>
																				</div>
																				<div class="cust_radio">
																						<input type="radio" id="radio-3-2" name="radio-1-set" disabled class="regular-radio accountType" value="2">
																						<label for="radio-3-2"></label>
																						<label class="click_radio" for="radio-3-2">Existing Business </label>
																				</div>
																				<div class="cust_radio">
																						<input type="radio" id="radio-3-3" disabled name="radio-1-set" class="regular-radio accountType" value="3">
																						<label for="radio-3-3"></label>
																						<label class="click_radio" for="radio-3-3">Business Ideas Only </label>
																				</div>
																		</div>
																		...
																		<div class="tab_content clear">
																								...
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														<div class="select_input clear">
																																<div class="cust_select_sec2">
																																		{!! Form::select('pv_currency', $currency, '',array('id'=>'pv_currency','class' => 'form-control','style' => 'background-color:#009AE1')) !!}
																																</div>
																				...
																				<div class="accountsNext submit_form">
																						{!! Form::button('Previous',array('id'=>'prev4','class'=>'buttonM bBlue prevArrow')) !!}
																						{!! Form::button('Finish',array('id'=>'next4','class'=>'buttonM bBlue')) !!}
																				</div>
																		</div>
																</div>
																<div class="business_otp_verify_div" style="display:none;">
																		<div class="three_option clear">
																				<h2>OTP Verification</h2>
																		</div>
																		<div class="tab_content clear">
																				<div class="start_exist1">
																						<div class="tab3_inner">
																								...
																								<div class="one_tab_inner otp_outer">																								
																										...
																										<div class="otp clear">
																												...
																												<button id="verify_button" class="buttonM bBlue buss_verify_button" type="button" autocomplete="off">Verify</button>
																												{!! Form::hidden('buss_otp_verify','0',array('id'=>'buss_otp_verify')) !!}
																												<input type="hidden" id="hid_otp_val_business" name="hid_otp_val_business" value="">
																										</div>
																								</div>
																								<div style="text-align:center;">Your Verification No Sent to <span id="contactno_buss"></span></div>
																						</div>
																								...
																								<div>Your Verification No Sent to <span id="contactno_buss"></span></div>-->
																						</div>
																				</div>
																				<div class="accountsNext submit_form">
																						{!! Form::button('Previous',array('id'=>'prev5','class'=>'buttonM bBlue')) !!}
	<!--																					{!! Form::button('Finish',array('id'=>'next5','class'=>'buttonM bBlue')) !!}
																				</div>
-->																		</div>
		...
		<style>
				.masterTooltipNew .infoBox {display: none;}
				.masterTooltipNew:hover .infoBox {display: block;}
		</style>
		<script>
				$("#add_file_1").change(function () {
				var ext = $('#add_file_1').val().split('.').pop().toLowerCase();
						var countfileno = $(this)[0].files.length;
						if(countfileno>5){
								alert('Upload maximum 5 files');
								$("#add_file_1").val('');
						}
				...
				$('input[name=business_type]').click(function(){
						...
						if (data_val == 'start_up') {
							$('#radio-3-1').trigger('click');	
						}
						if (data_val == 'existing_business' ) {
							$('#radio-3-2').trigger('click');
						}
						if (data_val == 'business_ideas' ) {
							$('#radio-3-3').trigger('click');
						}
				});
