...
<div class="signup_basic"  style="display:block;"> 
		...
		<div class="tab_content business_first_step clear" style="display:none;">
			...
			<div class="tab_form_left one_tab">
			  ...
			  <div class="one_tab_inner">{!! Form::text('bussiness_name','',array('id'=>'bussiness_name','placeholder'=>'Bussiness Name','class'=>'form-control')) !!}</div>
			...
			<div class="tab_form_right one_tab">
			  ...
			  <div class="one_tab_inner"> {!! Form::text('contact','',array('id'=>'contact','placeholder'=>' +8584322788','class'=>'form-control')) !!}<a href="javascript:void(0)" class="buss_verify_otp">Verify OTP</a>
	       <span class="buss_otp_status" style="color:red;"></span>{!! Form::hidden('buss_otp_verify','0',array('id'=>'buss_otp_verify')) !!}</div>			  
			</div>
		    </div>
		      </div>
		      <div class="tab_form clear">
			...
			<div class="tab_form_left one_tab">
			  ...
			  <div class="one_tab_inner">{!! Form::text('acta_number','',array('id'=>'acra_number','placeholder'=>'ACTA Number','class'=>'form-control required')) !!}</div>
			</div>
		      </div>
		    <div class="existing" style="display:none;">
			<div class="tab_form_right one_tab">
			  <label>Email Address</label>
			  <div class="one_tab_inner">{!! Form::email('buss_email',$email,array('id'=>'buss_email','placeholder'=>'Email','class'=>'form-control','readonly')) !!}</div>			  
			</div>
		    </div>
		      </div>
		      <div class="tab_form clear">
			...
			<div class="tab_form_left one_tab">
			  ...
			  <div class="one_tab_inner">{!! Form::text('no_year','',array('id'=>'no_year','placeholder'=>'Number of Year','class'=>'form-control required')) !!}</div>
			</div>
		      </div>
		    <div class="existing" style="display:none;">
			<div class="tab_form_right one_tab">
			  <label>Website</label>
			  <div class="one_tab_inner">{!! Form::text('website','',array('id'=>'website','placeholder'=>'Website','class'=>'form-control')) !!}</div>			  
			</div>
		    </div>
		      </div>
		    <div class="general"  style="display:none;">
			...
			<div class="tab_form_left full_tab">
			  ...
			  <div class="one_tab_inner">{!! Form::text('director_name[]','',array('id'=>'add_director_1','placeholder'=>'Director Name','class'=>'form-control required')) !!}<a href="javascript:void(0)" class="add_director">Add More + </a><input type="hidden" name="director_count" class="director_count" value="1"></div>
			</div>
		      </div>
		    </div>
		    <div class="business" style="display:none;">
			...
			<div class="tab_form_left full_tab">
			  ...
			  <div class="one_tab_inner textarea_sec">
			    ...
			    {!! Form::textarea('desc','',array('placeholder'=>'Description','id'=>'desc','class'=>'form-control parsley-validated desc required','maxlength'=>"2000")) !!}<div id="textarea_feedback"></div>
			  </div>
			</div>
		      </div>
		      <div class="tab_form clear">
 ...
 -->
	...
	<div id='file_tools'>
		...
		<span class="addSpan" id='add_file'>Add</span>
		      ...
		      <div class="submit_form">{!! Form::button('Next',array('id'=>'next2')) !!}</div>

		    </div>
		<div class="general"  style="display:none;">
		   
		    <div class="tab_content_right">
		      <img src="images/img11.jpg" alt="no img" id="buss_logo">{!! Form::file('image',array('class'=>"form-control", 'placeholder'=>"Logo", 'id'=>"image")) !!}
		...
		<div class="three_option clear">
		  ...
		  <div class="tab_content clear">
			...
			<div class="tab_form_left full_tab">
			  ...
			  <div class="one_tab_inner">{!! Form::number('equity_exchange','',array('id'=>'equity_exchange','placeholder'=>'%','class'=>'form-control required')) !!}</div>
			</div>
		      </div>
		      <div class="tab_form clear">
			<div class="tab_form_left full_tab">
			  <label class="dubble_line">Upload Your  <br>Proposal <span>(PDF, DOCX)</span></label>
			  <div class="one_tab_inner upload_prop"><img src="images/img13.jpg" alt="no img" id="proposalImage" style="cursor:pointer;">{!! Form::file('upload_proposal',array('id'=>'upload_proposal', 'placeholder'=>'Upload Proposal','class'=>'form-control upload_proposal ')) !!}
		  ...
		  <div class="tab_content clear">
			...
			<div class="tab_form_left full_tab">
		      ...
		      <p class="icon15">If you wish to get an accurate valuation, Contact us to get a valuation. <a href="javascript:void(0);" class="mail_accurate_valuation" data-href="{{$site_settings->sitesettings_value}}
 "  data-item="{{$site_settings->sitesettings_lebel}} ">click here</a></p>
		      
		      <div class="tab_form clear">
			<div class="tab_form_left full_tab">
			  <label class="dubble_line">Upload Your  <br>Proposal <span>(PDF, DOCX)</span></label>
			  <div class="one_tab_inner upload_prop"><img src="images/img13.jpg" alt="no img" id="proposalImage1"  style="cursor:pointer;">{!! Form::file('upload_proposal',array('id'=>'upload_proposal1', 'placeholder'=>'Upload Proposal','class'=>'form-control upload_proposal1 ')) !!}
