	    ...
	    {!! Form::hidden('password',$password,array('id'=>'password','placeholder'=>'Password','class'=>'form-control')) !!}
						<!--<div id="investor_div">
								...
								<div class="logControl">
										...
										{!! Form::button('Next',array('id'=>'go_to_basic','class'=>'buttonM bBlue')) !!}
								</div>           
						</div>-->
						...
						<div class="formRow" style="display:block;" id="form_basic">
								<div class="">
										...
										{!! Form::text('otp_verified',0,array('id'=>'otp_verified')) !!}
										<div class="form_sep">
												<label class="req">Are you A/An</label>
												{!! Form::radio('investor_type', 'Individual') !!} Individual<br>
												{!! Form::radio('investor_type', 'VC Firm') !!} VC Firm
										</div>
										<div class="form_sep">
										...
										<div class="form_sep">
												...
												{!! Form::number('contact','',array('id'=>'contact','placeholder'=>'Contact No With STD Code','class'=>'form-control')) !!}
										...
										<div class="form_sep">
												...
												{!! Form::email('email','',array('id'=>'email','placeholder'=>'Email','class'=>'form-control','readonly')) !!}
										</div>
										-->
										<div class="form_sep">
										...
										<div class="form_sep">
												...
												{!! Form::text('arca_no','',array('id'=>'arca_no','placeholder'=>'ARCA No','class'=>'form-control')) !!}
										</div>
										<div class="form_sep">
						...
						<div class="formRow" style="display:none;" id="form_fund">
								...
								<div class="form_sep">
										...
										{!! Form::select('annual_salary', array('100000' => '100000','200000'=>'200000','300000'=>'300000','400000'=>'400000'),'',array('class' => 'form-control','id'=> 'annual_salary')) !!}
								</div>
								<div class="form_sep">
										<label class="req">How much are you willing to invest?</label>
										{!! Form::select('willing_to_invest', array('100000' => '100000','200000'=>'200000','300000'=>'300000','400000'=>'400000'),'',array('class' => 'form-control','id'=> 'willing_to_invest')) !!}
								</div>
								<div class="form_sep">
										<a href="javascript:history.go(-1);" class="form_toggle">Back</a>
