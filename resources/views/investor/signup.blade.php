	  ...
	  <div class="resp-tabs-container">
		...
		<div class="tab_content clear">
			...
			<div class="tab_form_left one_tab">
			  <label>Name</label>
			  <div class="one_tab_inner">{!! Form::text('name','',array('id'=>'name','placeholder'=>'Name','class'=>'form-control')) !!}</div>
			</div>
		      </div>
		      <div class="tab_form clear">
			<div class="tab_form_left one_tab">
			  <label class="dubble_line">Contact<span>(OTP Verification)</span></label>
			  <div class="one_tab_inner">{!! Form::number('contact','',array('id'=>'contact','placeholder'=>'Contact No With Area Code','class'=>'form-control')) !!}</div>
			...
			<div class="tab_form_left one_tab">
			  <label>Company</label>
			  <div class="one_tab_inner">{!! Form::text('company_name','',array('id'=>'company_name','placeholder'=>'Company Name','class'=>'form-control')) !!}</div>
			</div>
			<div class="tab_form_right one_tab">
			  <label>Arca No</label>
			  <div class="one_tab_inner">{!! Form::text('arca_no','',array('id'=>'arca_no','placeholder'=>'ARCA No','class'=>'form-control')) !!}</div>			  
			</div>
		      </div>
