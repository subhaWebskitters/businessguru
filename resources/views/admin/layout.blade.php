...
<head><title>Business Guru Admin </title>
    ...
    <script src="{{ asset('admin_assets/js/jquery-2.2.4.min.js')}}"></script>
    ...
    @if (1/*Route::currentRouteName() != 'admin_menu_listing' && Route::currentRouteName() != 'admin_menu_edit'*/)    
...
<script type="text/javascript" src="{{ asset('admin_assets/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js') }}"></script>
        
<link type="text/css" rel="stylesheet" href="{{ asset('admin_assets/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') }}">
...
<div>
    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
        <nav id="topbar" role="navigation" style="margin-bottom: 0; z-index: 2;" class="navbar navbar-default navbar-static-top">
            <div class="navbar-header">
                ...
                <a id="logo" href="{{URL::route('admin_dashboard') }}" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">Admin</span><span style="display: none" class="logo-text-icon">HR</span></a></div>
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    <li class="dropdown topbar-user">
                    <a data-hover="dropdown" href="{{ URL::route('admin_dashboard') }}" class="dropdown-toggle">
                    @if(file_exists(public_path().'/upload/adminUser/'.Session::get('ADMIN_ACCESS_IMAGE')) && Session::get('ADMIN_ACCESS_IMAGE') !='')
                    {!! Html::image(asset('upload/adminUser/'.Session::get('ADMIN_ACCESS_IMAGE')), Session::get('ADMIN_ACCESS_IMAGE'),array('class'=>'img-responsive img-circle'))!!}
                    @else
                    {!! Html::image(asset('admin_assets/images/no-img.png'), 'no-img',array('class'=>'img-responsive img-circle'))!!}
                    @endif
                    &nbsp;<span class="hidden-xs">{{ Session::get('ADMIN_ACCESS_NAME') }}</span>&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            <!--<li><a href="extra-profile.html"><i class="fa fa-user"></i>My Profile</a></li>
                            -->
                            <li><a href="{{URL::route('edit_profile')}}"><i class="fa fa-edit"></i>Edit profile</a></li>
    ...
    <!--BEGIN SIDEBAR MENU-->
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    <li class="user-panel">
                        <div class="thumb">
                        @if(file_exists(public_path().'/upload/adminUser/'.Session::get('ADMIN_ACCESS_IMAGE')) && Session::get('ADMIN_ACCESS_IMAGE') !='')
                            {!! Html::image(asset('upload/adminUser/'.Session::get('ADMIN_ACCESS_IMAGE')), Session::get('ADMIN_ACCESS_IMAGE'),array('class'=>'img-circle'))!!}
                        @else
                            {!! Html::image(asset('admin_assets/images/no-img.png'), 'no-img',array('class'=>'img-responsive img-circle'))!!}
                        @endif
                        </div>
                        <div class="info"><p>{{ Session::get('ADMIN_ACCESS_NAME') }}</p>
                            <ul class="list-inline list-unstyled">
                                <li><a href="{{URL::route('edit_profile')}}" data-hover="tooltip" title="Profile"><i class="fa fa-user"></i></a></li>
                              <li><a href="{{URL::route('admin_logout')}}" data-hover="tooltip" title="Logout"><i class="fa fa-sign-out"></i></a></li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
                    </li>
                    <li class="{{Helpers::isActiveRoute('admin_dashboard')}}" ><a href="{{ URL::route('admin_dashboard') }}"><i class="fa fa-tachometer fa-fw">
                        <div class="icon-bg bg-orange"></div>
                    </i><span class="menu-title">Dashboard</span></a></li>
                    <li class="{{Helpers::isActiveRoute('admin_sitesettings')}}" ><a href="{{ URL::route('admin_sitesettings') }}"><i class="fa fa-cogs">
                        <div class="icon-bg bg-orange"></div>
                    </i><span class="menu-title">Site Settings</span></a></li>
                        
                        
                    
                    <li class="{{Helpers::isActiveRoute('currency')}}{{Helpers::isActiveRoute('currency_create')}}{{Helpers::isActiveRoute('currency_create_action')}}{{Helpers::isActiveRoute('currency_edit')}}{{Helpers::isActiveRoute('currency_update_action')}}{{Helpers::isActiveRoute('currency_delete')}}{{Helpers::isActiveRoute('currency_set_status')}}" >
                        <a href="{{ URL::route('currency') }}">
                            <i class="fa fa-dollar"></i>
                            <span class="submenu-title">Currency Management</span>
                        </a>
                    </li>
		    <!--<li class="{{Helpers::isActiveRoute('homepagebannerlist')}}{{Helpers::isActiveRoute('editbanner')}}" >
                        <a href="{{URL::route('homepagebannerlist')}}">
                            <i class="fa fa-picture-o"></i>
                            <span class="submenu-title">Banner Management</span>
                        </a>
                    </li>-->
                    <li class="{{Helpers::isActiveRoute('homepagebannerlist')}}{{Helpers::isActiveRoute('editbanner')}}{{Helpers::isActiveRoute('investorbannerlist')}}{{Helpers::isActiveRoute('addinvestorbanner')}}{{Helpers::isActiveRoute('editinvestorbanner')}}"><a href="javascript:void(0);"><i class="fa fa-picture-o"></i>
			<span class="menu-title">Banner Management</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse in" style="">
                            <li class="{{Helpers::isActiveRoute('homepagebannerlist')}}{{Helpers::isActiveRoute('editbanner')}}{{Helpers::isActiveRoute('addbanner')}}"><a href="{{URL::route('homepagebannerlist')}}"><i class="fa fa-angle-right"></i><span class="submenu-title">Discover Banner </span></a></li>
                            <li class="{{Helpers::isActiveRoute('investorbannerlist')}}{{Helpers::isActiveRoute('addinvestorbanner')}}{{Helpers::isActiveRoute('editinvestorbanner')}}"><a href="{{URL::route('investorbannerlist')}}"><i class="fa fa-angle-right"></i><span class="submenu-title">Investor Banner </span></a></li>
                        </ul>
                    </li>   
                    <li class="{{Helpers::isActiveRoute('industries_list')}}" >
                        <a href="{{ URL::route('industries_list') }}">
                            <i class="fa fa-building-o"></i>
                            <span class="submenu-title">Industry List</span>
                        </a>
                    </li>
                                
                    <li class="{{Helpers::isActiveRoute('admin_investors')}}" >
                    ...
                    <li class="{{Helpers::isActiveRoute('admin_business_users')}}" >
		    ...
		    <li class="{{Helpers::isActiveRoute('business_proposal')}}" >
                        <a href="{{ URL::route('business_proposal') }}">
                            <i class="fa fa-group"></i>
    ...
    <!--BEGIN CHAT FORM-->
        ...
        <!--BEGIN FOOTER-->
        <div id="footer">
            <div class="copyright">{{date('Y')}} &copy; Admin</div>
        </div>
        <!--END FOOTER--><!--END PAGE WRAPPER--></div>
</div>
    
    
<script src="{{ asset('admin_assets/vendors/bootstrap-markdown/js/bootstrap-markdown.js') }}"></script>
<script src="{{ asset('admin_assets/vendors/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}"></script>
<script src="{{ asset('admin_assets/vendors/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('admin_assets/vendors/summernote/summernote.js') }}"></script>
<script src="{{ asset('admin_assets/js/ui-editors.js') }}"></script>
