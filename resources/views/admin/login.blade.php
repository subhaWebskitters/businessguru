...
<div class="page-form">
		...
		@endif
    {!! Form::open(array('route' => 'admin', 'class' => 'form-validate','novalidate','id' => 'login_form')) !!}
        <div class="header-content"><h1>Log In</h1></div>
        <div class="body-content">

           
            <div class="form-group">
                <div class="input-icon right"><i class="fa fa-user"></i><input type="text" placeholder="Enter your Email"  value="{{$admin_email}}" name="admin_email" class="form-control required"></div>
            </div>
            <div class="form-group">
                <div class="input-icon right"><i class="fa fa-key"></i><input type="password" placeholder="Enter your Password" name="admin_password" class="form-control required" value="{{$admin_password}}"></div>
            </div>
            <div class="form-group pull-left">
                <div class="checkbox-list"><label><input type="checkbox" name="remember_login"  @if($admin_email) checked='checked' @endif>&nbsp;
