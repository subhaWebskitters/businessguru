...
@section('content')
    <div class="page-title-breadcrumb" id="title-breadcrumb-option-demo">
                <div class="page-header pull-left">
                    <div class="page-title">Company Payment</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li>
                    <i class="fa fa-shopping-cart"></i>&nbsp;
                    <a href="javascript:void(0);">Company Payment</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                    <li>
	    ...
	    <div class="page-content">
			...
			<div class="col-lg-12">
			<div class="portlet">
		    {!! Form::open(array('route'=>'admin_company_payment','method'=>'post','class'=>'form-validate','novalidate')) !!}
<div class="row">
			<div class="col-lg-3">
			...
			<div class="col-lg-6">
				...
				<a href="{{ URL::route('admin_company_payment') }}" class="btn btn-success" >View All</a>
			</div>
				</div>
			{!! Form::close() !!}
			</div>
										...
										<table class="table table-bordered table-striped table-condensed cf no-more-tables">
												...
												<tbody>
													    @if($lists->count() > 0)
															    @foreach($lists AS $r) 
																	    <tr>     
																	    <td data-title="Company Name">{{$r->name}}</td>
