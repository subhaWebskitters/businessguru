...
<div class="page-content">
		    ...
		    <div class="panel panel-yellow">
                            ...
                            <div class="panel-body pan">                                    
                                    {!! Form::open(array('route'=>array('admin_emirates_update_action',$lists->id),'class'=>'form-horizontal form-validate')) !!}
					...
					<div class="form-group"><label class="col-md-3 control-label" for="inputName">Select Country</label>
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                            {!! Form::select('country',$country_list,$lists->countries->id,array('class'=>'form-control required','id'=>'state' ))!!}
                                                </div>
                                            </div>
                                        </div>	
