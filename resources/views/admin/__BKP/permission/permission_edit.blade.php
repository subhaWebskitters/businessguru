...
@section('content')
    <div class="page-title-breadcrumb" id="title-breadcrumb-option-demo">
                <div class="page-header pull-left">
                    <div class="page-title"> Edit Permission</div>
                </div>
                    ...
                    <div class="col-lg-12">
                     <div class="portlet box portlet-orange">
                            <div class="portlet-header">
                                <div class="caption">Edit Permission</div>
                        ...
                        @endif
                            ...
                            @endif
{!! Form::open(array('route'=>'admin_permission_update','class'=>'form-validate','novalidate')) !!}
