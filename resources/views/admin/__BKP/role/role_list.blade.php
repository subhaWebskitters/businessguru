                     ...
                     <div class="portlet box portlet-orange">
                            ...
                            <div class="portlet-body">
								...
								<tr>     
									...
									<a class="btn btn-info" href="{{ URL::route('admin_role_edit',$r->id) }}" title="Edit" ><i class="fa fa-edit"></i>
									</a>
									<a class="btn btn-danger" href="{{ URL::route('admin_role_delete',$r->id) }}" title="Delete" onclick="return confirm('Are you sure! Do you want to delete this data along with role assign to this user?');" >
