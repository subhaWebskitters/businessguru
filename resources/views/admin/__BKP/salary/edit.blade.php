...
@section('content')
    <div class="page-title-breadcrumb" id="title-breadcrumb-option-demo">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <a href="{{ URL::route('admin_salary') }}">Salary</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                    <li>
...
<div class="page-content">
		    ...
		    <div class="panel panel-yellow">
                            ...
                            <div class="panel-body pan">                                    
                                    {!! Form::open(array('route'=>array('admin_salary_update_action',$lists->id),'class'=>'form-horizontal form-validate')) !!}
                                    <div class="form-body pal">
                                                ...
                                                @endif
                                        <div class="form-group"><label class="col-md-3 control-label" for="inputName">Salary Range</label>

                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                            {!! Form::text('title',$lists->title,array('class'=>'form-control required','placeholder'=>'Enter Salary Range','id'=>'inputName' ))!!}
                                                </div>
                                            </div>
                                        </div>
