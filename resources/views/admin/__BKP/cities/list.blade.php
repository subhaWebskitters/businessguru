                    ...
                    <div class="col-lg-12">
                     <div class="portlet box portlet-yellow">
                            <div class="portlet-header">
                                ...
                                <div class="actions">    <a class="btn btn-info btn-xs" href="{{ URL::route('admin_cities_create') }}"><i class="fa fa-plus"></i>&nbsp;
                                    Add New City</a>&nbsp;</div>
                            </div>
				            ...
				            <th width="30%">State Name</th>
								...
								<tr>
									...
									<a class="btn btn-info" href="{{ URL::route('admin_cities_edit',$r->id) }}" title="Edit" ><i class="fa fa-edit"></i>
									</a>
									<a class="btn btn-danger" href="{{ URL::route('admin_cities_delete',$r->id) }}" title="Delete" onclick="return confirm('Are sure! Do you want to delete with its all relevent data?');" >
