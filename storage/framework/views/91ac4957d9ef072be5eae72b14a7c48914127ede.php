...
<div id="top">
	...
	<!--<ul class="altMenu">
	    ...
	    <?php if(Session::has('USER_ACCESS_ROLE') != 'Client'): ?>
		<li <?php if(Route::current()->getName() == 'sitesettings'): ?> <?php echo e("class=activemenu"); ?> <?php endif; ?> ><a href="<?php echo e(URL::route('sitesettings')); ?>">Sitesettings</a></li>
	    <?php endif; ?>
	    <?php if(Auth::user()->ability(array('owner'), array('role_manage','role_permission_manage')) ): ?>
	    <li <?php if(Route::current()->getName() == 'role'||Route::current()->getName() =='role_permission_assign'): ?> <?php echo e("class=activemenu"); ?> <?php endif; ?>>
	    <a href="javascript:;">Role</a>
			    <ul class="roleManage">
			    <?php if(Auth::user()->ability(array('owner'), array('role_manage')) ): ?>
				    <li <?php if(Route::current()->getName() == 'role'): ?> <?php echo e("class=activemenu"); ?> <?php endif; ?> ><a href="<?php echo e(URL::route('role')); ?>">Role Management</a></li>
				    <?php endif; ?>
				    <?php if(Auth::user()->ability(array('owner'), array('role_permission_manage')) ): ?>
				    <li <?php if(Route::current()->getName() == 'role_permission_assign'): ?> <?php echo e("class=activemenu"); ?> <?php endif; ?> ><a href="<?php echo e(URL::route('role_permission_assign')); ?>">Role Permission Management</a></li>
				    <?php endif; ?>
			    </ul>
	    </li>
	    <?php endif; ?>
	    <?php if(Auth::user()->ability(array('owner'), array('user_manage')) ): ?>
	    <li <?php if(Route::current()->getName() == 'user'): ?> <?php echo e("class=activemenu"); ?> <?php endif; ?> ><a href="<?php echo e(URL::route('user')); ?>">User Management</a></li>
	    <?php endif; ?>
	    <?php if(Auth::user()->ability(array('owner'), array('project_manage','add_discussion')) ): ?>
	    ...
	    <a href="javascript:;">Project</a>
			    <ul>
				    <?php if(Auth::user()->ability(array('owner'), array('project_manage')) ): ?>
				    <li <?php if(Route::current()->getName() == 'project'): ?> <?php echo e("class=activemenu"); ?> <?php endif; ?> ><a href="<?php echo e(URL::route('project')); ?>">Project Management</a></li>
				    <?php endif; ?>
			    </ul>
	    </li>
	    <?php endif; ?>
	    <?php if(Auth::user()->ability(array('owner'), array('client_manage')) ): ?>
	    <li <?php if(Route::current()->getName() == 'client'): ?> <?php echo e("class=activemenu"); ?> <?php endif; ?> ><a href="<?php echo e(URL::route('client')); ?>">Client Management</a></li>
	    <?php endif; ?>
