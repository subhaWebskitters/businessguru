...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-book_alt"></span>Add Design</span>        
    </div>
    ...
    <div class="wrapper">
	  ...
	  <div align="center">
		...
		<?php endif; ?>
                ...
                <div class="whead"><h6>Add Design</h6></div>
                  <?php echo Form::open(['route'=>'store_design','class' => 'form form-validate formRow','enctype'=>'multipart/form-data']); ?>
