...
<?php $__env->startSection('content'); ?>
	...
	<div class="center ani_img">
	  <img src="images/icon1.png" alt="no img" class="icon1 outer_border wp9 wp">
	  <span class="text1">Lorem Ipsum is simply dummy</span>
	  <img src="images/icon2.png" alt="no img" class="icon2 outer_border wp9 wp">
	  <span class="text2">Lorem Ipsum is simply dummy</span>
	  <img src="images/icon3.png" alt="no img" class="icon3 outer_border wp9 wp">
	  <span class="text3">Lorem Ipsum is simply dummy</span>
	  <img src="images/icon4.png" alt="no img" class="icon4 outer_border wp9 wp">
	  <span class="text4">Lorem Ipsum is simply dummy</span>
	  <div class="center_ele">
	    <img src="images/icon5.png" alt="no img">
	...
	<div class="block6_2 clear">
	  ...
	  <div class="half_half clear">
	    ...
	    <div class="right_half"><img class="full_border" src="images/img8.jpg" alt="no img"></div>
	  </div>
	  <div class="half_half clear">
	    <div class="right_half"><img class="full_border" src="images/img8.jpg" alt="no img"></div>
	    <div class="left_half">
	...
	<div class="same_gap block6_3 clear">
	  <div id="owl-demo" class="owl-carousel">
	    <div class="item clear">
	      <div class="slider1_left"><img class="full_border" src="images/img9.jpg" alt="no img"></div>
