...
<?php $__env->startSection('content'); ?>
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title">Add New Industry</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <a href="javascript:void(0);">Add New Industry </a>&nbsp;&nbsp;
            </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-yellow">
                    <div class="panel-heading">Industry Add</div>
                    <div class="panel-body pan">                                    
                        ...
                        <?php endif; ?>
                        <?php echo e(Form::open(array('route'=>array('industry_add')))); ?>
                            ...
                            <div class="form-body pal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            <?php echo e(Form::text('industry_name','',array('class'=>'form-control required'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                        <?php echo e(Form::select('status',array('Active'=>'Active','Inactive'=>'Inactive'),'',array('class'=>'form-control'))); ?>
