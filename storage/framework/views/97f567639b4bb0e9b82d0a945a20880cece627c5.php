																		...
																		<div class="tab_content_left">
																				...
																				<div class="tab_form clear">
																						<div class="tab_form_left one_tab">
																								...
																								<div class="one_tab_inner">
																										<?php echo Form::text('contact','',array('id'=>'contact','placeholder'=>'Contact No With country Code(+917278523411)','class'=>'form-control')); ?>
																				...
																				<div class="tab_form clear">
																						...
																						<div class="tab_form_right one_tab">
																								...
																								<div class="one_tab_inner">
																										<?php echo Form::text('arca_no','',array('id'=>'arca_no','placeholder'=>'ACRA Number','class'=>'form-control')); ?>
																				...
																				<div class="tab_form clear">
																						<div class="tab_form_left full_tab">
																								...
																								<div class="one_tab_inner textarea_sec">
																										<?php echo Form::textarea('address', null, ['id'=>'address','placeholder'=>'Address','class' => 'form-control field desc']); ?>
																						...
																						<div class="tab_form_left full_tab full-tab_new new_tab1 width50">
																								...
																								<div class="one_tab_inner tab_select">
																										<div class="select-business">
																												<?php echo Form::select('industry_status[]', $industries,'',array('class' => 'form-control required ddown industrystatuscheckbox','multiple id'=> 'industries','multiple'=>'multiple')); ?>
																												...
																												<div id="checkboxes" class="clear">
																														<?php foreach($industries as $key => $val): ?>
																																<label for="one"><input type="checkbox" class="industrystatuscheckbox" name="industry_status[]" value="<?php echo e($key); ?>" id="industries"/><?php echo e($val); ?></label>
																														<?php endforeach; ?>
																		...
																		<div class="p2_tab2">
																						...
																						<div class="tab_form_left full_tab width30">
																								...
																								<div class="one_tab_inner tab_select">
																										<!--<div class="cust_select_sec2">
																												<?php echo Form::select('as_currency', $currency, '',array('id'=>'as_currency','class' => 'form-control')); ?>

																										</div>-->
																												<?php echo Form::select('annual_salary', array('0-5000'=>'0-5000','5001-10000' => '5001-10000','10001-30000'=>'10001-30000','30001-50000'=>'30001-50000','50001-100000'=>'50001-100000','>100000'=>'>100000'),'',array('class' => '','id'=> 'annual_salary')); ?>
																				...
																				<div class="tab_form clear">
																						<div class="tab_form_left full_tab width30">
																								...
																								<div class="one_tab_inner tab_select">
																										<!--<div class="cust_select_sec2">
																												<?php echo Form::select('wi_currency', $currency, '',array('id'=>'wi_currency','class' => 'form-control')); ?>

																										</div>-->
																												<?php echo Form::select('willing_to_invest',  array('0-5000'=>'0-5000','5001-10000' => '5001-10000','10001-30000'=>'10001-30000','30001-50000'=>'30001-50000','50001-100000'=>'50001-100000','>100000'=>'>100000'),'',array('class' => '','id'=> 'willing_to_invest')); ?>

																								</div>
																						</div>
																				</div>
																				<div class="submit_form">
																						<?php echo Form::button('Next',array('id'=>'go_to_otp_verify','class'=>'buttonM bBlue')); ?>
