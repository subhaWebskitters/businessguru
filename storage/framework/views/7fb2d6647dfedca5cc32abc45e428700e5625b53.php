...
<?php $__env->startSection('content'); ?>
    <div class="page-title-breadcrumb" id="title-breadcrumb-option-demo">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <a href="<?php echo e(URL::route('edit_profile')); ?>">Edit Profile</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                    <li>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right state-success">
                                                            <?php echo Form::text('name',$lists->name,array('class'=>'form-control required','placeholder'=>'Enter First Name','id'=>'name' )); ?>
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                            <?php echo Form::file('image',array('class'=>'','id'=>'image' )); ?>
							    ...
							    <?php echo e(Html::image(asset('upload/adminUser/'.$lists->image),$lists->image,array('height'=>'100','width'=>'100'))); ?>
                                    ...
                                    <div class="form-actions pal">
                                        <div class="form-group mbn">
                                            ...
                                            <?php echo Html::linkRoute('admin_dashboard', 'Back', array(), array('class' => 'btn btn-default')); ?>
