...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-suitcase"></span>Add Role</span>        
    </div>
    ...
    <div class="wrapper">
	  ...
	  <div align="center">
		...
		<?php endif; ?>
                ...
                <div class="whead"><h6>Add Role</h6></div>
                 <?php echo Form::open(['route'=>'add_role','class' => 'form form-validate formRow']); ?>
