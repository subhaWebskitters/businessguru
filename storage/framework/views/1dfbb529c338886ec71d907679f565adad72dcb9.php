    ...
    <br>
					    ...
					    <th>Business Name</th>
								...
								<tr>
									...
									<td><?php echo e($r->get_investor_detail()->first()->name); ?></td>
                                                                        <td><?php echo e($r->get_business_detail()->first()->business_name); ?></td>
                                                                        <td class='status-<?php echo e($r->id); ?>'>
                                                                        
                                                                        <?php if($r->status == 'Requested'): ?>
                                                                            <a href="javascript:" class="btn btn-default btn-xs btn-warning"><i class="fa"></i>Requested</a>
                                                                        <?php else: ?>
                                                                            <a href="javascript:" class="btn btn-default btn-xs btn-success"><i class="fa"></i>Approved</a>					
                                                                        <?php endif; ?> 
                                                                        </td>
									<td>
