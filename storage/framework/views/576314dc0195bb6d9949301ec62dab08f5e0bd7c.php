<?php $__env->startSection('content'); ?>
  ...
  <div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-users"></span>User List</span>
	<ul class="quickStats">
            <li>
                <?php if(Auth::user()->ability(array('owner'), array('add_user')) ): ?><a href="<?php echo e(URL::route('add_user')); ?>" class="blueImg"><img alt="" src="<?php echo e(asset('admin_assets/images/icons/quickstats/plus.png')); ?>"></a><?php endif; ?>
                <div class="floatR">
    ...
    <div class="breadLine">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li class="current"><a href="#" title="">User List</a></li>
            </ul>
        </div>
    </div>
	...
	<?php if(Session::has('errorMessage')): ?>
	  <div align="center">
        ...
        <div class="widget check">
            <div class="whead">
		<!--<span class="titleIcon"><input type="checkbox" id="titleCheck" name="titleCheck" /></span>--><h6>User List</h6>
	    </div>
	    ...
	    <div class="tablePars" style="display:block">
			<?php echo Form::open(array('class' => 'searchForm', 'id' => 'search_form' , 'method' => 'post')); ?>
				...
				<label>Search:
				    <?php echo Form::text('search',$search,array('required','id'=>'search','placeholder'=>'Search by Name or Email or status or Role','class'=>'userSearchBox searchBox')); ?>
			...
			<div id="checkAll_length" class="dataTables_length">
			    <?php echo $adminuser_list->render(); ?>
		  ...
		  <?php if($adminuser_list->count() > 0): ?>
		      <?php foreach($adminuser_list AS $r): ?>
		      ...
		      <!--<td class="sorting_1 noBorderB">
				...
				<span><input type="checkbox" id="titleCheck" name="page[]" value="<?php echo e($r->id); ?>" class="chkBox" /></span></div></td>-->
                        <td>
			  <?php if($r->image!= '' && file_exists(public_path().'/upload/adminuser/'.$r->image) ): ?>
			...
			<td><?php echo e($r->created_at); ?></td>
                        <td><?php if(Auth::user()->ability(array('owner'), array('edit_user')) ): ?><a class="tablectrl_small bDefault tipS editIcon" href="<?php echo e(URL::route('edit_user',$r->id)); ?>" title="Edit"><span class="iconb" data-icon="&#xe1db;"></span></a><?php endif; ?>
			<?php if(Auth::user()->ability(array('owner'), array('delete_user')) ): ?><a class="tablectrl_small bDefault tipS deleteIcon" href="<?php echo e(URL::route('delete_user',$r->id)); ?>" onclick="return confirm('Are you sure you want to delete this?');" title="Remove"><span class="iconb" data-icon="&#xe136;"></span></a><?php endif; ?></td>
                      </tr>
                       <?php endforeach; ?>
		        <?php else: ?>
