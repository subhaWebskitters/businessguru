	...
	<?php if(Session::has('errorMessage')): ?>
	  <div align="center">
			...
			<div class="right">
			 <h3> <?php echo $v->getAdminDetails->name; ?></h3>
			  ...
			  <div class="attachment">
			    ...
			    <?php echo Html::image(asset('upload/attachment/'.$v->attached_file),'',array('class'=>'img-responsive img-circle','width'=>'140')); ?>
	    ...
	    <div class="panel panel-default" id="design" style="display:none;">
              <div class="panel-heading clearfix">
                <h4 class="panel-title">Design</h4> <a href="<?php echo e(URL::route('add_design',$project_details[0]->id)); ?>">Add Design</a> 
              </div>	     
              <div class="panel-body">
