		...
		<div id="main" class="clear">
				<div class="errorSuccess">
						<?php if(Session::has('errorMessage')): ?>
								<div class="nNote nFailure"><p><?php echo e(Session::get('errorMessage')); ?></p></div>
						<?php endif; ?>
						<?php if(Session::has('successMessage')): ?>
								<div class="nNote nSuccess"><?php echo e(Session::get('successMessage')); ?></div>
						<?php endif; ?>
																						...
																						<div class="tab_form clear">
																								<div class="business" style="display:none;">
																										<div class="tab_form_left one_tab">
																												...
																												<div class="one_tab_inner">
																														<?php echo Form::text('bussiness_name','',array('id'=>'bussiness_name','placeholder'=>'Bussiness Name','class'=>'form-control')); ?>
																								...
																								<div class="existing" style="display:none;">
																										<div class="tab_form_right one_tab">
																												...
																												<div class="one_tab_inner">
																														<?php echo Form::text('contact','',array('id'=>'contact','placeholder'=>' Contact No With country Code(+123456789)','class'=>'form-control')); ?>
																						...
																						<div class="tab_form clear">
																								<div class="general"  style="display:none;">
																										<div class="tab_form_left one_tab">
																												...
																												<div class="one_tab_inner">
																														<?php echo Form::text('acta_number','',array('id'=>'acra_number','placeholder'=>'ACRA Number','class'=>'form-control required')); ?>
																								...
																								<div class="existing" style="display:none;">
																										<div class="tab_form_right one_tab">
																												...
																												<div class="one_tab_inner">
																														<?php echo Form::email('buss_email', $email, array('id'=>'buss_email', 'placeholder'=>'Email', 'class'=>'form-control','readonly')); ?>
																						...
																						<div class="tab_form clear">
																								<div class="general"  style="display:none;">
																										<div class="tab_form_left one_tab">
																												...
																												<div class="one_tab_inner">
																														<?php echo Form::text('no_year','',array('id'=>'no_year','placeholder'=>'Number of Year', 'class'=>'form-control required')); ?>
																								...
																								<div class="existing" style="display:none;">
																										<div class="tab_form_right one_tab">
																												<label>Website</label>
																												<div class="one_tab_inner">
																														<?php echo Form::url('website','http://',array('id'=>'website','placeholder'=>'http://www.website.com/', 'class'=>'form-control')); ?>
																						...
																						<div class="general" style="display:none;">
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														<?php echo Form::text('director_name[]','',array('id'=>'add_director_1','placeholder'=>'Director Name','class'=>'form-control required')); ?>
																										...
																										<div class="tab_form_left full_tab full-tab_new">
																												...
																												<div class="one_tab_inner tab_select">
																														<div class="select-business">
																															<?php echo Form::select('business_cat[]', $industry, '',array('multiple id'=>'business_cat','class' => 'form-control businessCatCheckbox','multiple' => "multiple")); ?>
																																...
																																<div id="checkboxes" class="clear">
																																	...
																																	<?php foreach($industry as $key => $val): ?>
																																		<label for="one"><input type="checkbox" name="business_cat[]" value="<?php echo e($key); ?>" id="business_cat" class="businessCatCheckbox" /><?php echo e($val); ?></label>
																																	<?php endforeach; ?>
...
-->																								</div>
  																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab full-tab_new">
																												...
																												<div class="one_tab_inner tab_select">
																														<div>
															<?php echo Form::select('investor_type', array(''=>'Select Investor Type','Single Investors'=>'Single Investors','Multiple Investors'=>'Multiple Investors','Both Investors'=>'Both Investors'),'',array('class' => '','id'=> 'investor_type','style' => 'background-color:white;height:41px')); ?>
																								...
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner textarea_sec">
																														...
																														<?php echo Form::textarea('desc','', array('placeholder'=>'Description', 'id'=>'desc', 'class'=>'form-control parsley-validated desc required','maxlength'=>"2000")); ?>
											...
											<p>																			<?php echo Form::file('upload_doc[]',array('id'=>'add_file_1', 'placeholder'=>'Upload Doc','class'=>'form-control upload_doc ')); ?>
											...
											<p>
																						...
																						<div class="submit_form">
																								<?php echo Form::button('Next',array('id'=>'next2')); ?>
																						...
																						<div class="tab2_inner">
																												...
																												<div class="one_tab_inner">
																														<div class="select_input clear">
																																<div class="cust_select_sec2">
																																		<?php echo Form::select('funds_req_currency', $currency, '',array('id'=>'funds_req_currency','class' => 'form-control' , 'style' => 'background-color:#009AE1')); ?>
																								...
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														<?php echo Form::number('equity_exchange', '',array('id'=>'equity_exchange', 'placeholder'=>'%', 'class'=>'form-control required')); ?>
																				...
																				<div class="tab_content clear">
																						<div class="tab2_inner">
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														<div class="select_input clear">
																																<div class="cust_select_sec2">
																																		<?php echo Form::select('sp_currency', $currency, '',array('id'=>'sp_currency','class' => 'form-control','style' => 'background-color:#009AE1')); ?>
																								...
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														<div class="select_input clear">
																																<div class="cust_select_sec2">
																																		<?php echo Form::select('cv_currency', $currency, '',array('id'=>'cv_currency','class' => 'form-control', 'style' => 'background-color:#009AE1')); ?>
																								...
																								<p class="icon15">If you wish to get an accurate valuation, Contact us to get a valuation.
																										<a href="javascript:void(0);" class="mail_accurate_valuation" data-href="<?php echo e($site_settings->sitesettings_value); ?>"  data-item="<?php echo e($site_settings->sitesettings_lebel); ?>">click here</a>
																								</p>
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												<label class="dubble_line">Upload Your  <br>Proposal <span>(PDF, DOCX)</span></label>
																												<div class="one_tab_inner upload_prop">
																														...
																														<?php echo Form::file('upload_proposal_selling',array('id'=>'upload_proposal1', 'placeholder'=>'Upload Proposal','class'=>'form-control upload_proposal1 ')); ?>
																										...
																										<div class="tips_inner clear">
																												...
																												<div class="tips_right">
																														<p>Proposal format is preferred by Spring Singapore
																																<a href="<?php echo e(URL::route('download_file','1463563557.docx')); ?>" class="download_files" data-file="filename.txt">click here</a> to download a copy
																														</p>
																												</div>
																										</div>
																								</div>
		  ...
		  <h2>we need your books...</h2>
																		...
																		<div class="tab_content clear">
																								...
																								<div class="tab_form clear">
																										<div class="tab_form_left full_tab">
																												...
																												<div class="one_tab_inner">
																														<div class="select_input clear">
																																<div class="cust_select_sec2">
																																		<?php echo Form::select('pv_currency', $currency, '',array('id'=>'pv_currency','class' => 'form-control','style' => 'background-color:#009AE1')); ?>
																				...
																				<div class="accountsNext submit_form">
																						<?php echo Form::button('Previous',array('id'=>'prev4','class'=>'buttonM bBlue prevArrow')); ?>
																...
																<div class="business_otp_verify_div" style="display:none;">
																		...
																		<div class="tab_content clear">
																						...
																						<div class="tab3_inner">
																								...
																								<div class="one_tab_inner otp_outer">																								
																										...
																										<div class="otp clear">
																												...
																												<?php echo Form::hidden('buss_otp_verify','0',array('id'=>'buss_otp_verify')); ?>
																				...
																				<div class="accountsNext submit_form">
																						<?php echo Form::button('Previous',array('id'=>'prev5','class'=>'buttonM bBlue')); ?>

	<!--																					<?php echo Form::button('Finish',array('id'=>'next5','class'=>'buttonM bBlue')); ?>
