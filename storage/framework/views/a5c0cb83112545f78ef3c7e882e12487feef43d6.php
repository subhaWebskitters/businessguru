	...
	<div class="deatils_outer clear">
	  <div class="summary">
	    <div class="border_box">
	      <h3>Summary:</h3>
	   <?php echo Form::textarea('business_description',$businessDetails->business_description,array('class'=>'ckeditor','id'=>'business_description','cols'=>'75','rows'=>'10' )); ?>   
		...
		<?php foreach($business_files as $files): ?>
			<li><a class="fancybox2" rel="group" href="<?php echo e(asset('upload/businessfiles/'.$files->file_name)); ?>" title="<?php echo e($files->file_name); ?>" ><?php echo e(Html::image(asset('upload/businessfiles/thumb/'.$files->file_name),$files->file_name)); ?></a>
			<br>
			<a href="javascript:void(0);" class="remove_photo" data-id="<?php echo e($files->id); ?>">Remove</a>
			</li>
		...
		<br>
	      <label class="upload_max">Upload Multiple Image(Max 5)</label>
				...
				<?php echo Form::file('media[]',array('class'=>"form-control", 'placeholder'=>"Logo", 'id'=>"image", 'multiple' => 'multiple')); ?>
	    ...
	    <div class="border_box upload_img clear">
	      <h3>Company Portfolio</h3>
	        ...
	        <?php if(COUNT($uploaded_document)>0): ?>
						<ul>
						...
						<li>
						    ...
						    <a href="<?php echo e(URL::route('download_file',$filename)); ?>">
						    <div class="portfolio_display"><?php echo Html::image(asset('upload/attachment/'.$filename),'Download',array('title'=>'Download '.Helpers::get_extension($filename),'height'=>'100px','width'=>'100px' )); ?>

						    </div>
						    <span class="comPortfolioDoc"><?php echo e($filename); ?></span>
						    </a>
						  <a href="javascript:void(0);" class="remove_doc" data-id="<?php echo e($doc_id); ?>">Remove</a>
						</li>
							    <?php endif; ?>    
		...
		<ul>
	      <?php if(COUNT($business_bio)>0): ?>
						...
						<?php foreach($business_bio as $v): ?>
									...
									<li><span class="spanDirectorName"><?php echo e($v->director_name); ?></span><p class="spanDirectorBio"><?php echo e($v->director_bio); ?></p>
...
<div class="imageUploadDiv">
	  ...
	  <div class="looking">
		...
		<h4>Selling/Investment</h4>
		  ...
		  <?php echo Form::select('sp_currency', $currency, $businessDetails->sp_currency,array('id'=>'sp_currency','class' => 'form-control')); ?>

		<?php echo Form::number('enter_selling_amt',$businessDetails->selling_price,array('id'=>'enter_selling_amt','placeholder'=>'Enter Amount','class'=>'form-control required')); ?>

		<span>
		<?php echo Form::text('equity_exchange',$businessDetails->equity_exchange,array('id'=>'equity_exchange','placeholder'=>'Enter Amount','class'=>'form-control required')); ?>%</span>
	      </div>
		...
		<?php endif; ?>
	      <a href="<?php echo e(URL::route('download',array('salse',$businessDetails->sales_report_name))); ?>" class="download">Download sales report</a>
		<div class="imageUploadDiv">
