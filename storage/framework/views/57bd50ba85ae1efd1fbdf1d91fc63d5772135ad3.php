...
<?php $__env->startSection('content'); ?>
  <div id="main" class="clear">
	...
	<div class="center block1_center">
	  ...
	  <img src="<?php echo e(asset('front_assets/assets/images/img3.jpg')); ?>" alt="no img">
	  <h3>And what others don't see is <span>their loss and our gain.</span></h3>
	</div>
      </div>
    </div>
    <div class="block2 same_gap">
      <img src="<?php echo e(asset('front_assets/assets/images/img4.jpg')); ?>" alt="no img" class="none">
      <div class="main_container clear">
    ...
    <div class="full_img"><img src="<?php echo e(asset('front_assets/assets/images/img5.jpg')); ?>" alt="no img"></div>    
