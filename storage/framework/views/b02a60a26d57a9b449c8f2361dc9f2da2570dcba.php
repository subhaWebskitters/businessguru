...
<?php echo Form::open(['name'=> 'frmLogin', 'route'=>['save_invester_step'],'id'=>'investor_sign_in','class' => 'form form-validate','enctype'=>'multipart/form-data']); ?>
				...
				<?php echo Form::hidden('type','Investor',array('id'=>'type')); ?>
										...
										<div class="form_sep">
												<div class="modal-footer">
														<a href="<?php echo e(URL::route('register')); ?>" class="btn btn-default">Close</a>
										...
										<div class="form_sep">
												<div class="modal-footer">
														<a href="<?php echo e(URL::route('save_invester_step')); ?>" style="text-decoration:none;">Sign Up&nbsp;&nbsp;</a>
														<a href="<?php echo e(URL::route('forgot_password')); ?>" style="text-decoration:none;">&nbsp;&nbsp;Forgot Password?</a>
												</div>
										</div>
								</form> 
						</div>
  	...
  	<div class="modal fade" id="myBusinessModal" role="dialog">
    <div class="modal-dialog modal-sm">
				<div class="modal-content">
						<div class="modal-header">
								<!--<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<?php echo Form::open(['name'=> 'frmLogin', 'route'=>['business_login'],'id'=>'business_sign_in','class' => 'form form-validate frmLogin','enctype'=>'multipart/form-data']); ?>
				...
				<?php echo Form::hidden('type','Business',array('id'=>'type')); ?>
										...
										<div class="form_sep">
												<div class="modal-footer">
														<a href="<?php echo e(URL::route('save_business_step')); ?>" style="text-decoration:none;">Sign Up&nbsp;&nbsp;</a>
														<a href="<?php echo e(URL::route('business_forgot_password')); ?>" style="text-decoration:none;">&nbsp;&nbsp;Forgot Password?</a>
												</div>
										</div>
								</form> 
						</div>
